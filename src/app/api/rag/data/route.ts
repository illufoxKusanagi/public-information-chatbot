...
export async function POST(request: NextRequest) {
  try {
    ...
    for (let i = 0; i < ragDataToInsert.length; i++) {
      ...
      try {
        // Edited Here: Properly await the embedding generation
...
// // Edited Here: Added embedding property to all objects in ragDataToInsert array
// const ragDataToInsert = [
//   {
//     content: "Ir. Tontro Pahlawanto menjabat sebagai Sekretaris Daerah.",
//     data: {
...
//   try {
//     // Edited Here: Fixed the embedding generation logic and proper async handling
//     const processedData = [];
...
//       // Convert embedding to number array if needed
//       const embeddingArray = Array.isArray(embedding)
//         ? embedding.map((e) =>
//             typeof e === "number" ? e : parseFloat(e.toString())
//           )
//         : [];
...
// // Edited Here: Added GET method for testing
// export async function GET(request: NextRequest) {
//   try {
//     const connectionTest = await testDatabaseConnection();
//     const schema = await checkRagDataSchema();
...
// //   try {
// //     let ragDatas;
// //     for (let i = 0; i < insertRagData.length + 1; i++) {
// //       ragDataToInsert[i].embedding = generateEmbedding(
// //         ragDataToInsert[i].content
// //       );
// //     }
